...
public class HealthDataParserUtil {
	...
	public static void parseHealthDataToDatabase(String xmlFilePath, String dbUrl, String dbUser, String dbPassword, int userId) throws IOException, ParserConfigurationException, SAXException, SQLException {
	...
	private static Map<String, Map<String, Map<String, DailyData>>> parseXmlAndGroupByDevice(String xmlFilePath) throws ParserConfigurationException, SAXException, IOException {
